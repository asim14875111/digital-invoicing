              ...
              <div className="flex justify-between items-center">
                <div className="flex gap-5">
                  ...
                  <div className="flex gap-1 items-center">
                    ...
                    <p className="text-sm">{data.Transactiondatendtype?.date}</p>
                  </div>
                  <div className="flex gap-1 items-center">
                    <label className="font-bold text-gray-600">
                      Customer:
                    </label>
                    <p className="text-sm">{data.Customerdetails?.name}</p>
                  </div>
                  <div className="flex gap-1 items-center">
                    <label className="font-bold text-gray-600">
                      Amount:
                    </label>
                    <p className="text-sm">{data.Itemdetails?.[0]?.price}</p>
                  </div>
                  <div className="flex gap-1 items-center">
                    <label className="font-bold text-gray-600">
                      Status:
                ...
                <div className="bg-white shadow-md p-4 mt-4 rounded-md">
                  <div className="flex justify-between gap-10">
                    <div>
                      ...
                      <p>
                        <strong>Name:</strong> {data.Customerdetails?.name}
                      </p>
                      <p>
                        <strong>CNIC/NTN:</strong> {data.Customerdetails?.CNIC}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Email:</strong> {data.Customerdetails?.email}
                      </p>
                      <p>
                        <strong>Status:</strong> {data.Customerdetails?.status}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Site:</strong> {data.Customerdetails?.Site}
                      </p>
                      <p>
                    ...
                    <div>
                      ...
                      <h3 className="font-bold mt-4 mb-2">Item Details</h3>
                      <p>
                      ...
                      <p>
                        <strong>SRO:</strong> {data.Itemdetails?.[0]?.SRO}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>UOM:</strong> {data.Itemdetails?.[0]?.Uom}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Price:</strong> {data.Itemdetails?.[0]?.price}
                      </p>
                      <p>
