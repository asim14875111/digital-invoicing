...
export default function Home() {
  ...
  return (
    <div className="">
      <div className="flex flex-col justify-between px-10 pt-14">
        {display && (
          <>
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="ml-6 bg-gray-700 text-white cursor-pointer px-4 py-2 rounded-md text-sm hover:bg-gray-800 transition"
                    >
